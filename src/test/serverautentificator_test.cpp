...
protected:
    std::unique_ptr<net::server::Authentificator> a =
        std::make_unique<net::server::Authentificator>(
        net::server::auth::PasswordServer::getPasswordServer(net::server::AbstractPasswordServer::Kind::file, "passwords"));
